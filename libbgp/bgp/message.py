...
class Message(object):
    ...
    def unpack(cls, data, capability={}):
        ...
        if len(data) < cls.HDR_LEN:
            ...
            raise MessageUncompleted("The message is uncompleted or the rest hasn't arrived yet.")
        ...
        klass = cls.registered_message[msg_type].unpack(data=msg_body, capability=capability)
        return klass
